...
import EightQueensGame from './games/eightqueen_game/main';
import KnightTourMain from './games/knighttour_game/KnightTourMain';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/knightsTourGame' element={<KnightTourMain />} />
